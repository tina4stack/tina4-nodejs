...
## Commits (tina4-nodejs, branch fix/mongo8-sqlsrv-lastid)
- 51d5907  Test runs never open a browser: guard the default, cover vitest
- 8792183  CI: run the Mongo suites against a MongoDB 8 replica set too
